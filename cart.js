...
// Function to initialize the cart when the DOM content is loaded
function ready() {
    // Add event listeners for removing cart items, changing quantities, and purchasing
...
// Configuration for Stripe Checkout
